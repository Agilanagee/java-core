...
public class D04P03 {
	...
	public static void main(String[] args) {
		try {
			Applicant1 applicant = new Applicant1("Mary", "Assistant", 34);
			validate(applicant);
		} catch (CatheyBankException e) {
			System.out.println(e.getMessage());
		}
		try {
			Applicant1 applicant = new Applicant1("Mary", "Clerk", 27);
			validate(applicant);
		} catch (CatheyBankException e) {
			System.out.println(e.getMessage());
		}
		try {
			Applicant1 applicant = new Applicant1("Joseph","Probationary Officer", 30);
			validate(applicant);
		} catch (CatheyBankException e) {
			System.out.println(e.getMessage());
		}
