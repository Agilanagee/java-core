...
public class D05P10 {
    public static void main(String[] args) {
        ...
        personSet.add(new Person4(1, "Alice", 30, 5000));
        personSet.add(new Person4(2, "Bob", 35, 6000));
        personSet.add(new Person4(3, "Charlie", 25, 4000));
        personSet.add(new Person4(4, "Jonas", 22, 6999));
        personSet.add(new Person4(5, "Emily", 28, 5500));
        personSet.add(new Person4(6, "Jack", 40, 7500));
