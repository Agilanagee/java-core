...
public class D05P09 {
    public static void main(String[] args) {
        ...
        personSet.add(new Person3(1, "Alice", 30, 4500));
        personSet.add(new Person3(2, "Bob", 35, 2500));
        personSet.add(new Person3(3, "Charlie", 25, 4000));
        personSet.add(new Person3(4, "Jonas", 22, 3000));
        personSet.add(new Person3(5, "Emily", 28, 3994));
        personSet.add(new Person3(6, "Jack", 40, 5000));
